        ...
        */
        ...
        $book = Book::updateOrCreate(
            ...
            [
                ...
                'author'          => 'J. K. Rowling',
                'published_year'  => 2014,
                'description'     => "Harry enters his fourth year at Hogwarts and is unexpectedly chosen as a Triwizard Champion, facing dangerous magical tasks while a dark plot slowly unfolds around him.",
                'rating'          => 4.3,
                'category'        => 'Fantasy',
                'total_copies'    => 0,
                'available_copies'=> 0,
        ...
        $book = Book::updateOrCreate(
            ...
            [
                ...
                'author'          => 'Amal El-Mohtar',
                'published_year'  => 2015,
                'description'     => "A curated collection of 21 speculative-fiction tales that appeared on the longer nomination list for the Hugo Awards, offering sci-fi, fantasy and horror from global voices.",
                'rating'          => 4.0,
                'category'        => 'Science Fiction',
                'total_copies'    => 0,
                'available_copies'=> 0,
